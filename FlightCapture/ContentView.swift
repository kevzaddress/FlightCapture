        ...
        NavigationView {
            ScrollView {
                                        ...
                                        ForEach(Array(cockpitCrewDisplay.enumerated()), id: \.offset) { index, crew in
                                            HStack(spacing: 12) {
                                                ...
                                                HStack(alignment: .center, spacing: 8) {
                                                    ...
                                                    ConfidenceDot(confidence: calculateCrewNameConfidence(crew.name))
                                                }
                                                .padding(.vertical, 8)
                ...
                Spacer()
                    ...
                    // Review All Data button - moved below crew cards
                    if flightNumber != nil && aircraftReg != nil && departureAirport != nil && arrivalAirport != nil {
                        Button(action: {
        ...
        HStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("Date")
                    .font(.caption)
                    .foregroundColor(.secondary)
                Text(date != nil ? formatDate(date!) : "No date available")
                    .font(.headline)
                    .fontWeight(.semibold)
                    .foregroundColor(.primary)
            }
...
enum ConfidenceLevel {
    ...
    var color: Color {
        ...
        case .medium: return Color(red: 1.0, green: 0.8, blue: 0.0) // vibrant yellow
        case .low: return .red
        }
    }
}
